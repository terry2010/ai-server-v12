...
const initialServices: ServiceModule[] = [
  {
    ...
    status: 'running',
    metrics: { cpu: 32, memory: 48, port: '5678', uptime: '2 小时 15 分钟' },
  },
  {
    key: 'dify',
    name: 'Dify',
    ...
    status: 'stopped',
    metrics: { cpu: 0, memory: 0, port: '8081', uptime: '—' },
  },
  {
    key: 'oneapi',
    name: 'OneAPI',
...
export function DashboardPage() {
  const [services, setServices] = useState<ServiceModule[]>(initialServices)
