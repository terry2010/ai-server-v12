...
const mockLogs: LogItem[] = [
  ...
  {
    id: 28,
    timestamp: '2025-09-16 19:34:35',
    level: 'warn',
    module: 'n8n',
    service: 'container-n8n',
    message: 'Webhook 请求出现 429，已开启重试。',
  },
  {
    id: 29,
    timestamp: '2025-09-16 19:35:01',
    level: 'info',
    module: 'dify',
    service: 'container-dify',
    message: '导入新的应用模板包完成。',
  ...
  {
    id: 30,
    timestamp: '2025-09-16 19:35:40',
    level: 'debug',
    module: 'ragflow',
    service: 'container-ragflow',
    message: '段落切分策略为 sentence，最大长度 500。',
  },
]
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 text-[11px] text-slate-500 dark:text-slate-400">
        <span>
          共 {filteredLogs.length} 条 · 每页 {pageSize} 条 · 第 {page} / {totalPages} 页
        </span>
